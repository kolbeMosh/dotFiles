...
export const AccountDetails = ({
  ...
  //   __title: Yup.string().required(),
  //   __firstName: Yup.string().required(),
  //   __lastName: Yup.string().required(),
  //   __email: Yup.string().required(),
  //   __phoneNumber: Yup.string(),
  //   __password: Yup.string().required(),
  //   __confirmPassword: Yup.string()

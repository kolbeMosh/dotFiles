...
import { Doodle1Svg } from '../../../components/icons/doodles/doodle-1';
import { DoodlePagesSvg } from '../../../components/icons/doodles/doodle-pages';
...
export const OnBoardingModalHeader = ({
  ...
  return (
    <div className='relative flex flex-col gap-1 bg-ibc-orange py-8 text-center text-white hover:text-[#2379fb]'>

...
export const AccountDetails = ({
  ...
  useEffect(() => {
    setIsValid(
      !!(firstName && lastName && password && email && acceptTOS && !passErr)
    );
  }, [firstName, lastName, password, email, acceptTOS, passErr]);
      ...
      <>
        ...
        <div className='mb-3'>
          <Input
            ...
            onBlur={() => {
              isValidData(password, setPassErr, {
                presence: true,
                format: {
        ...
        <div className='mb-3'>
          <Input
            ...
            onBlur={() => {
              isValidData(phoneNumber, setPhoneErr, {
                presence: true,
                format: {
                  pattern: '^(([0-9]{3}) |[0-9]{3}-)[0-9]{3}-[0-9]{4}$',
                  message:
                    'Must be a valid number and match format (123) 456-7890 or 123-456-7890'
                }
              });
            }}
            isInvalid={!!phoneErr}

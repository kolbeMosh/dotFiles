...
import { ParentOnboardingFlowProps } from './ParentOnboardingFlow';

type AddChildProps = ParentOnboardingFlowProps & {
...
export const ChildInfo = (onBackClick, currentStep, birthday, headerColor) => {
